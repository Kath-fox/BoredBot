...
document.getElementById("get-activity").addEventListener("click", function() {
    fetch("https://apis.scrimba.com/bored/api/activity")
      ...
      document.getElementById("activity").classList.add('animate__animated', 'animate__fadeIn', 'fadein')
    
    setTimeout(() => {
      document.getElementById("activity").classList.remove('animate__animated', 'animate__fadeIn')
    }, 1000)
})